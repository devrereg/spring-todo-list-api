...
public enum Code {
    ...
    // USER_NICKNAME_DUPLICATED(13010, HttpStatus.BAD_REQUEST, "User nickname
    // duplicated"),
    ...
    public static Code valueOf(HttpStatus httpStatus) throws Exception {
        if (httpStatus == null) {
            throw new Exception("HttpStatus is null.");
        }
